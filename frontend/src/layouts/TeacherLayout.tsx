...
const TeacherLayout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 transition-colors duration-200">
      ...
      >
        {/* Sidebar Header */}
        <div className="h-16 flex items-center justify-between px-4 border-b border-slate-880/50">
          <Logo 
          ...
          <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'mb-4 px-2'}`}>
            ...
            {!isCollapsed && (
              <div className="ml-3 truncate text-left">
                ...
                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Teacher</p>
              </div>
            )}
          </div>
          {!isCollapsed && (
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <div className="flex items-center gap-2.5 text-left">
              ...
              <div className="hidden sm:block">
                <p className="text-xs font-extrabold text-slate-850 dark:text-white leading-none">Dr. {user?.lastName || user?.firstName}</p>
                <p className="text-[9px] font-bold text-slate-400 mt-1 uppercase tracking-wider leading-none">Faculty Teacher</p>
              </div>
            </div>
          </div>
        </header>
