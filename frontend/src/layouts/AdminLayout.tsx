  ...
  const navigation = [
    { 
      ...
      items: [
        ...
        { name: 'Assessments', href: '#', icon: ClipboardList },
        { name: 'Reports', href: '#', icon: FileText },
        { name: 'Communication', href: '#', icon: MessageSquare },
        { name: 'Site Settings', href: '#', icon: Settings },
        { name: 'Integrations', href: '#', icon: Globe },
            ...
            <div className="space-y-3">
              <div className="flex items-center px-1">
                ...
                <div className="ml-3 truncate text-left">
                  ...
                  <p className="text-[10px] font-bold text-slate-500 uppercase mt-1 leading-none">Super Administrator</p>
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <div className="flex items-center gap-2.5 text-left">
              ...
              <div className="hidden sm:block">
                <p className="text-xs font-bold text-slate-700 dark:text-slate-200 leading-none">Admin User</p>
