          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input type="password" name="password" required value={formData.password} onChange={handleChange} className="w-full border-slate-300 rounded-md border p-2 focus:ring-blue-500 focus:border-blue-500" />
              </div>
              ...
              {role === 'TEACHER' && (
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="text" name="specialization" required value={formData.specialization} onChange={handleChange} className="w-full border-slate-300 rounded-md border p-2 focus:ring-blue-500 focus:border-blue-500" />
                  </div>
                </div>
              )}
              ...
              {role === 'STUDENT' && (
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="text" name="academicYear" required value={formData.academicYear} onChange={handleChange} className="w-full border-slate-300 rounded-md border p-2 focus:ring-blue-500 focus:border-blue-500" />
                  </div>
                </div>
              )}
