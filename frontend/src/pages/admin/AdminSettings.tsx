  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <div>
        ...
        <p className="text-[14px] mt-0.5" style={{ color: 'var(--text-muted)' }}>Manage your personal profile and system preferences.</p>
      </div>
          ...
          <div className="card">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea className="input w-full text-[13px] min-h-[100px] resize-none" value={bio} onChange={e => setBio(e.target.value)} placeholder="System administrator for OpenLearnX..." />
              </div>
            </div>
